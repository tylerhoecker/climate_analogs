...
alert("datasets for 1000x0x10p loaded")
...
alert("starting analogs 1000x0x10p")
...
# profvis({
  ...
  0, # In KM! 
  max_dist, # In KM!
  (project_dir * "/data/sensitivity/1000km_0min_10p"), ClimateAnalogs.calculate_analogs_threaded); #

alert("analog results 1000x0x10 complete")
