...
alert("datasets for 1000x0x50p loaded")
...
# profvis({
  ...
  0, # In KM! 
  max_dist, # In KM!
  (project_dir * "/data/sensitivity/1000km_0min_50p"), ClimateAnalogs.calculate_analogs_threaded); #

alert("analog results 1000x0x50 complete")
