...
alert("datasets for 250x0x50p loaded")
...
alert("starting analogs 250x0x50p")
...
# profvis({
  ...
  0, # In KM! 
  max_dist, # In KM!
  (project_dir * "/data/sensitivity/250km_0min_50p"), ClimateAnalogs.calculate_analogs_threaded); #

alert("analog results 250x0x50 complete")
