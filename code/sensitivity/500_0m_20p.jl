...
alert("datasets for 500x0x20p loaded")
...
alert("starting analogs 500x0x20p")
...
# profvis({
  ...
  0, # In KM! 
  max_dist, # In KM!
  (project_dir * "/data/sensitivity/500km_0min_20p"), ClimateAnalogs.calculate_analogs_threaded); #

alert("analog results 500x0x20 complete")
